...
def get_path(filename: str = None, folder: str = None) -> None:
...
def _retrieve_filename(file: Union[str, FileStorage]) -> str:
    ...
    Allows our functions to call this with both filenames
    and FileStorages and always return a file name
    """
...
def get_basename(file: Union[str, FileStorage]) -> str:
    """
    Return the full name of image in the path
